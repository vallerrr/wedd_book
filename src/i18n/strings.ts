...
export const strings = {
  zh: {
    ...
    'bingo.saveFailed': '这张照片没能保存，请再试一次，或换一张。',
    ...
    'gallery.printChoose': '选这张冲印',
    'gallery.printChosen': '已选 ✓',
    'gallery.printsLeft': '还可以选 {n} 张冲印',
    'gallery.printsDone': '已选好 {n} 张冲印',
    'gallery.printLimit': '冲印名额已经选满了，可以先取消一张再选',
    'gallery.printFailed': '没选上，请再试一次',
  ...
  en: {
    ...
    'bingo.saveFailed': "That photo couldn't be saved. Try again, or pick another one.",
    'camera.uploadStuck':
    ...
    'gallery.printChoose': 'Choose to print',
    'gallery.printChosen': 'Chosen ✓',
    'gallery.printsLeft': '{n} prints left to choose',
    'gallery.printsDone': '{n} prints chosen',
    'gallery.printLimit': 'That’s all your prints — unpick one first',
    'gallery.printFailed': 'Couldn’t add that one. Try again?',
